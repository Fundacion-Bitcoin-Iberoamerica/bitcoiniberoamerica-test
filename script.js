...
const translations = {
  es: {
    ...
    labitcollege_desc: "Programa académico que brinda a estudiantes universitarios y profesores una experiencia inmersiva en LABITCONF combinada con una certificación oficial de Bitcoin.",
    ...
    labif_p13_desc: "Educación Bitcoin, adopción comercial y tecnología accesible para construir economías circulares Bitcoin duraderas en República Dominicana.",
    labif_p14_title: "LABITCONF Bitcoin College",
    labif_p14_desc: "Brindar a estudiantes universitarios y profesores una experiencia inmersiva en LABITCONF combinada con una certificación académica de Bitcoin.",
    labif_p15_title: "ColomBiap2p",
    labif_p15_desc: "Educación sobre Bitcoin, Lightning y Nostr, ejecución de nodos, privacidad y economía circular Bitcoin en Colombia.",
    tag_investigacion: "Investigación",
    ifeb_desc: "Concurso académico internacional del <strong>Instituto de Filosofía y Economía Bitcoin</strong>. Investigación en economía, filosofía, sociedad y tecnología Bitcoin. Premio en BTC con entrega en LABITCONF.",
    tag_comunidad: "Comunidad",
    pizzaday_desc: "Celebración anual del 22 de mayo organizada por la <strong>ONG Bitcoin Argentina</strong>. Más de 1.200 bitcoiners se reúnen con pizzas, música, networking y donaciones solidarias a comedores comunitarios.",
    tag_aliado_hon: "Aliado Honorífico",
    tag_sponsor: "Sponsor",
    bsg_desc: "Conferencia internacional de alto nivel celebrada desde 2018 en Montevideo, Uruguay. Líderes de tecnología, finanzas y sector público analizan cómo <strong>Bitcoin</strong>, blockchain y las nuevas tecnologías se integran en la economía digital.",
  ...
  en: {
    ...
    labitcollege_desc: "Academic program offering university students and professors an immersive LABITCONF experience combined with an official Bitcoin certification.",
    ...
    labif_p10_title: "Discovering Bitcoin Uruguay",
    labif_p10_desc: "Educating new communities in Uruguay about Bitcoin through free workshops, open materials and a simple, measurable and replicable methodology.",
    labif_p11_title: "La Bitcoineta",
    labif_p11_desc: "Bringing free Bitcoin and financial sovereignty education to communities across Argentina, one mobile workshop at a time.",
    labif_p12_title: "BitDevs Lima",
    labif_p12_desc: "A meeting format replicated in various cities over the world, now happening in LIMA! One of the main financial hubs in LATAM.",
    labif_p13_title: "Satoshi Somos Todos",
    labif_p13_desc: "Helping others learn about Bitcoin in everyday life, with education, merchant adoption and accessible technology, we build lasting Bitcoin circular economies.",
    labif_p14_title: "LABITCONF Bitcoin College",
    labif_p14_desc: "Provide university students and professors with an immersive LABITCONF experience combined with an academic Bitcoin certification.",
    labif_p15_title: "ColomBiap2p",
    labif_p15_desc: "Bitcoin, Lightning, and Nostr education, node operation, privacy maximization, and Bitcoin circular economy in Colombia.",
    tag_investigacion: "Research",
    ifeb_desc: "International academic competition by the <strong>Instituto de Filosofía y Economía Bitcoin</strong>. Research on Bitcoin economics, philosophy, society and technology. Prize in BTC awarded at LABITCONF.",
    tag_comunidad: "Community",
    pizzaday_desc: "Annual celebration on May 22 organized by <strong>ONG Bitcoin Argentina</strong>. Over 1,200 bitcoiners gather for pizza, music, networking, and charitable donations to community dining halls.",
    tag_aliado_hon: "Honorary Ally",
    tag_sponsor: "Sponsor",
    bsg_desc: "High-level international conference held since 2018 in Montevideo, Uruguay. Technology, finance, and public sector leaders analyze how <strong>Bitcoin</strong> and new technologies integrate into the digital economy.",
  ...
  pt: {
    ...
    labitcollege_desc: "Programa acadêmico que oferece a estudantes universitários e professores uma experiência imersiva na LABITCONF combinada com uma certificação oficial de Bitcoin.",
    tag_iniciativa: "Iniciativa FBI",
    labif_sponsors_label: "Sponsors:",
    ...
    labif_p10_title: "Descobrindo Bitcoin Uruguai",
    labif_p10_desc: "Educar novas comunidades no Uruguai sobre Bitcoin por meio de oficinas gratuitas, materiais abertos e uma metodologia simples, mensurável e replicável.",
    labif_p11_title: "La Bitcoineta",
    labif_p11_desc: "Educação gratuita sobre Bitcoin e soberania financeira levada a comunidades da Argentina, um workshop móvel por vez.",
    labif_p12_title: "BitDevs Lima",
    labif_p12_desc: "O formato de meetup técnico Bitcoin replicado em cidades ao redor do mundo, agora em Lima, um dos principais centros financeiros da LATAM.",
    labif_p13_title: "Satoshi Somos Todos",
    labif_p13_desc: "Ajudando outros a aprender sobre Bitcoin no cotidiano, com educação, adoção comercial e tecnologia acessível para construir economias circulares Bitcoin duradouras.",
    labif_p14_title: "LABITCONF Bitcoin College",
    labif_p14_desc: "Oferecer a estudantes universitários e professores uma experiência imersiva na LABITCONF combinada com uma certificação acadêmica de Bitcoin.",
    labif_p15_title: "ColomBiap2p",
    labif_p15_desc: "Educação sobre Bitcoin, Lightning e Nostr, operação de nós, privacidade e economia circular Bitcoin na Colômbia.",
    tag_investigacion: "Pesquisa",
    ifeb_desc: "Concurso acadêmico internacional do <strong>Instituto de Filosofia e Economia Bitcoin</strong>. Pesquisa em economia, filosofia, sociedade e tecnologia Bitcoin. Prêmio em BTC com entrega na LABITCONF.",
    tag_comunidad: "Comunidade",
    pizzaday_desc: "Celebração anual em 22 de maio organizada pela <strong>ONG Bitcoin Argentina</strong>. Mais de 1.200 bitcoiners se reúnem com pizzas, música, networking e doações solidárias para refeitórios comunitários.",
    tag_aliado_hon: "Aliado Honorário",
    tag_sponsor: "Sponsor",
    bsg_desc: "Conferência internacional de alto nível realizada desde 2018 em Montevidéu, Uruguai. Líderes de tecnologia, finanças e setor público analisam como o <strong>Bitcoin</strong> e as novas tecnologias se integram à economia digital.",
