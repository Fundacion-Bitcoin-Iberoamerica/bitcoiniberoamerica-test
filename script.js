...
const translations = {
  es: {
    ...
    tag_sponsor: "Sponsor",
    bsg_desc: "<strong>Blockchain Summit Global</strong> es una conferencia internacional de alto nivel celebrada desde 2018 en Montevideo, Uruguay. Líderes de tecnología, finanzas y sector público analizan cómo <strong>Bitcoin</strong>, blockchain y las nuevas tecnologías se integran en la economía digital.",
  ...
  en: {
    ...
    tag_sponsor: "Sponsor",
    bsg_desc: "<strong>Blockchain Summit Global</strong> is a high-level international conference held since 2018 in Montevideo, Uruguay. Technology, finance, and public sector leaders analyze how <strong>Bitcoin</strong> and new technologies integrate into the digital economy.",
  ...
  pt: {
    ...
    tag_sponsor: "Sponsor",
    bsg_desc: "<strong>Blockchain Summit Global</strong> é uma conferência internacional de alto nível realizada desde 2018 em Montevidéu, Uruguai. Líderes de tecnologia, finanças e setor público analisam como o <strong>Bitcoin</strong> e as novas tecnologias se integram à economia digital.",
